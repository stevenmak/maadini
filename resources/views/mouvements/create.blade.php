...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <strong>EFFECTUEZ UN MOUVEMENT DE STOCK</strong>
        </div>
        <div class="card-body">
            {!! Form::open(array('action' => 'MouvementController@save','method'=>'POST')) !!}
            <div class="row row-sm">
                ...
                <div class="form-group col-6">
                    <input type="hidden" class="form-control"  name="mouvements[type_id]" required value="1">
                </div>
            </div>
            <hr>
            <div>
